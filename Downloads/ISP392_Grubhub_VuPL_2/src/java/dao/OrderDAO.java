...
public class OrderDAO extends MyDAO {
    ...
    public List<Order> getOrdersByCustomerId(int customerId) {
        List<Order> orders = new ArrayList<>();
        String sql = "SELECT o.id, o.total_amount, o.status, o.order_date,o.restaurant_id "
                + "FROM [Order] o "
                + "WHERE o.customer_id = ?";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                // Nếu cần thêm các trường dữ liệu khác của Order, bạn có thể thêm vào đây
    ...
    public void cancelOrder(int orderId) {
        String sql = "UPDATE [Order] SET status = 'Đã hủy' WHERE id = ?";
        try {
            ps = con.prepareStatement(sql);
            ps.setInt(1, orderId);
            ps.executeUpdate();
    ...
    public static void main(String[] args) {
        ...
        Order n = orderDAO.getOrderById(4026);
