...
//                x = new Product(xProduct_id, xName, xPrice, xDescription, xImage, xStatus, xCreate_date, xCategory_id, xRestaurant_id);
    ...
    public List<Product> getProductByCID(String cproduct_id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Category c = cd.getCategoryId(rs.getInt("category_id"));
                float xRating = rs.getFloat("rating");
                Product x = new Product(xPrice, xName, xPrice, xQuantity, xDescription, xImage, xStatus, xRating, xCreate_date, s, c);
    ...
    public static void main(String[] args) {
        ...
        List<Product> list = pd.listTop5();
//        Product p = pd.getProduct("1");
