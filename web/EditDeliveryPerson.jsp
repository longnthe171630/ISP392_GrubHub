...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            DeliveryPerson deliveryperson = (DeliveryPerson) request.getAttribute("deliver");
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="my-5">
                        <a href="deliverydashboard" class="text-decoration-none" >&larr; Back</a>
                        <h3>Grubhub</h3>
                        <hr>
                    </div>
            ...
            <form id="form-1" action="editdelivery" method="get" class="file-upload" enctype="multipart/form-data">
...
<!--                                <div class="col-md-6">
                                    <label class="form-label">Avatar</label>
                                     Hiển thị ảnh avatar bo tròn 
                                    <div class="mb-3">
                                        <img src="<%= account.getImg() %>" alt="Avatar" class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder aria-label="name" value="<%= deliveryperson.getName() %>" readonly> 
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="dob" placeholder aria-label="Date of birth" value="<%= deliveryperson.getDob() != null ? deliveryperson.getDob() : "" %>" readonly>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="gend">
                                    <a>Gender</a><br>
                                    <input type="radio" name="gender" id="male" value="Male" <%= !deliveryperson.isGender() ? "checked" : "" %> disabled>
                                    <label for="male">Male</label><br>
                                    <input type="radio" name="gender" id="female" value="Female" <%= deliveryperson.isGender() ? "checked" : "" %> disabled>
