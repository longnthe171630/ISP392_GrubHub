...
<html lang="en">
    <head>
        ...
        <title><fmt:message key="notification" bundle="${lang}"/></title>
    </head>
        ...
        <section id="content">
            ...
            <nav>
                ...
                <div class="dropdown-container">
                    <div class="notification">
                        <i class='bx bxs-bell'  style = "color: #ff0000"></i>
                        <span class="num"></span>
                    </div>
                </div>
            ...
            <main>
                <div class="head-title">
                    <div class="left">
                        <h1><fmt:message key="notification" bundle="${lang}"/></h1>
                        <ul class="breadcrumb">
                            <li>
                            ...
                            <li>
                                <a class="active" href="deliverynotice"><fmt:message key="notification" bundle="${lang}"/></a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="table-data">
                    <div class="order">
                        <div class="head">
                            <h3><fmt:message key="notification" bundle="${lang}"/></h3>
                        </div>
                        <p style = "color: red">${err}</p>
                        <table>
                            <c:choose>
                                <c:when test="${fn:length(list) == 0}">
                                    <p class="empty-message"><fmt:message key="note4" bundle="${lang}"/></p>
                                </c:when>
                                <c:otherwise>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <c:forEach var="n" items="${list}">
                                            <tr>
                                                ...
                                                <c:set var="des" value="${n.descripsion eq 'The order has been delivered successfully!' ? 'des_succ' : 'des_fail'}" />
                                                <td><p><strong><fmt:message key="note6" bundle="${lang}"/></strong><fmt:message key="${des}" bundle="${lang}"/></p></td>
                                                <td class="notification-time" data-time="${n.notice_time}"></td>
                                                <td>
                                                    <button  onclick="openModal(${n.order_id})" style="cursor: pointer;"><fmt:message key="view" bundle="${lang}"/></button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
