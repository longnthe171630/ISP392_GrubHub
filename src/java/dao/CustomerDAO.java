...
//            ps.setDate(2, new java.sql.Date(c.getDob().getTime())); // Chuyển đổi từ java.util.Date sang java.sql.Date
    ...
    public String getPhoneNumberByCustomerId(int customer_id){
        xSql = "SELECT phonenumber FROM Customer where id = ?";
        Customer x = null;
        try {
            ps = con.prepareStatement(xSql);
...
// test function
    ...
    public static void main(String[] args) {
        ...
        System.out.println(cd.getPhoneNumberByCustomerId(1));
    }
}
