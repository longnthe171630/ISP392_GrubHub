 ...
 * @author Long1
 */
@WebServlet(name = "LoadingDeliveryProfileServlet", urlPatterns = {"/loadingdeliveryprofile"})
public class LoadingDeliveryProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        DeliveryPersonDAO dp = new DeliveryPersonDAO();
        ...
        int deliverpersonID = dp.getIdByAccId(accID);
        DeliveryPerson d = dp.getDeliveryPerson(deliverpersonID);
