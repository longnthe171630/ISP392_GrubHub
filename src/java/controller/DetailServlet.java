...
public class DetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Product ID: " + productId); // Check if productId is correct
        System.out.println("Restaurant ID: " + restaurantId); // Check if restaurantId is correct
