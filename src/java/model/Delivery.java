...
public class Delivery {
    ...
    public String toString() {
        return "Delivery{" + "id=" + id + ", order_id=" + order_id + ", delivery_person_id=" + delivery_person_id + ", ship_price=" + ship_price + ", delivery_date=" + delivery_date + ", status=" + status + ", image=" + image + ", start_time=" + start_time + ", end_time=" + end_time + '}';
    }
